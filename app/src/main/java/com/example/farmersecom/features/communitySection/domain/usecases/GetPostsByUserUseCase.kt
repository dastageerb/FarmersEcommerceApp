...
class GetPostsByUserUseCase @Inject constructor(private val communityRepository: CommunityRepository)
{

    suspend fun getPostsByUser() = communityRepository.getPostsByUser()
